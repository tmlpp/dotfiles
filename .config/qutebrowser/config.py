...
config.bind(',k', 'hint images userscript save_img_url')
config.bind(',m', 'hint links spawn mpv {hint-url}')
config.bind(',M', 'spawn mpv {url}')
config.bind(',ny', 'spawn --userscript yt.to.newsboat')
config.bind(',nY', 'hint links userscript yt.to.newsboat')
config.bind(',nr', 'spawn --userscript reddit.to.newsboat')
config.bind(',nR', 'hint links userscript reddit.to.newsboat')
