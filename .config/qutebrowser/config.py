from profile_specific_config import *
...
with config.pattern("reddit.com") as p:
    p.hints.selectors["all"] += ["r-post-form-submit-button",
                                 "reddit-search-large"]
...
config.bind(',L', 'hint links yank-primary')
config.bind(',b', 'hint all tab-bg')
config.bind(',d', 'hint links download')
#config.bind(',f', 'hint all tab-fg')
config.bind(',f', 'hint links spawn qutebrowser -T {hint-url}')
config.bind(',h', 'hint all hover')
config.bind(',i', 'hint images download')
config.bind(',k', 'hint images userscript save.url')
# config.bind(',m', 'hint links spawn mpv --player-operation-mode=pseudo-gui {hint-url}')
...
config.bind(',n', 'spawn --userscript get_rss.py')
config.bind(',N', 'cmd-set-text -s :spawn --userscript get_rss.py ')
...
config.bind('gC', 'tab-clone --private')
# config.bind('gO', 'cmd-set-text :open -t -r {url:pretty}')
config.bind('gy', 'spawn --userscript edit-current-url-one-level-up')
config.bind('gY', 'spawn --userscript edit-current-url-one-level-up t')
